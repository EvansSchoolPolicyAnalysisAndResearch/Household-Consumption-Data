...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Uganda National Panel Survey (UNPS) LSMS-ISA Wave 8 (2019-20)
...
*The data were collected over the period March 2019 - February 2020.
...
*-----------
*Household ID variables				Uganda_UNPS_W8_hhids.dta
*Food Consumption by source			Uganda_UNPS_W8_food_consumption_value_by_source.dta
...
//set directories: 
global Uganda_UNPS_W8_raw_data 			"$directory/uganda-wave8-2019-20/raw_data/UGA_2019_UNPS_v01_M_STATA14"
global Uganda_UNPS_W8_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Uganda_UNPS_W8_exchange_rate 3718.249			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=UG // average of 2019/2020
global Uganda_UNPS_W8_gdp_ppp_dollar 1270.6080   	// https://data.worldbank.org/indicator/PA.NUS.PPP // average of 2019/2020
global Uganda_UNPS_W8_cons_ppp_dollar 1221.0876		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP // average of 2019/2020
global Uganda_UNPS_W8_inflation -0.083041  	        	// https://data.worldbank.org/indicator/FP.CPI.TOTL.ZG?locations=UG inflation rate 2019-2020. Data was collected during 2019-2020. We want to adjust the monetary values to 2017


*Re-scaling survey weights to match population estimates
*https://databank.worldbank.org/source/world-development-indicators#
global Uganda_UNPS_W8_pop_tot 44404611
global Uganda_UNPS_W8_pop_rur 33323884
global Uganda_UNPS_W8_pop_urb 11080727
...
*HOUSEHOLD IDS
************************
use "${Uganda_UNPS_W8_raw_data}/HH/gsec2.dta", clear
ren h2q8 age
ren h2q3 gender
...
use "${Uganda_UNPS_W8_raw_data}/HH/gsec1", clear
gen str strhhid = hhid
replace hhid = ""
compress hhid
replace hhid = strhhid
...
gen ccf_loc = (1 + $Uganda_UNPS_W8_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $Uganda_UNPS_W8_inflation)/$Uganda_UNPS_W8_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Uganda_UNPS_W8_inflation)/ $Uganda_UNPS_W8_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Uganda_UNPS_W8_inflation)/ $Uganda_UNPS_W8_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"

save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_hhids_noea.dta", replace

 
 ********************************************************************************
*CONSUMPTION
******************************************************************************** 
use "${Uganda_UNPS_W8_raw_data}/HH/gsec15a.dta", clear
keep if CEA01==1
...
use "${Uganda_UNPS_W8_raw_data}/HH/gsec15b.dta", clear
keep if CEB03==1
gen str strhhid = hhid
replace hhid = ""
compress hhid
...
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	1531
...
replace crop_category1=	"Vegetables"	if  item_code==	1721
...
replace crop_category1=	"Other Cereals"	if  item_code==	1734
...
replace `unit'_unit_new="Other" if `unit'_unit==900 | `unit'_unit==999
...
replace `unit'_qty= `unit'_qty*2 if `unit'_unit_new=="Bottle (2tr)"				// 2 ltr Bottle Liter to Liter
...
merge m:1 hhid using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_hhids_noea.dta", nogen keep (1 3)

save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_consumption_purchase.dta", replace
 
  
* parish
use "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_consumption_purchase.dta", clear
drop if price_unit==.
gen observation = 1
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_parish.dta", replace
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_scounty.dta", replace
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_county.dta", replace
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_district.dta", replace
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_region.dta", replace
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_country.dta", replace
...
merge m:1 parish_code item_code food_purch_unit_new using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_parish.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 scounty_code item_code food_purch_unit_new using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_scounty.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 county_code item_code food_purch_unit_new using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_county.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 district_code item_code food_purch_unit_new using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 region item_code food_purch_unit_new using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 item_code food_purch_unit_new using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_item_prices_country.dta", nogen keep(1 3)
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_consumption_purchase_consu.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_consumption_purchase_prod.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_consumption_purchase_gift.dta", nogen
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_food_home_consumption_value.dta", replace
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_food_away_consumption_value.dta", replace


use "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_food_home_consumption_value.dta", clear
append using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_food_away_consumption_value.dta"
merge m:1 hhid using "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_hhids_noea.dta", nogen keep(1 3)
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_food_consumption_value.dta", replace
...
save "${Uganda_UNPS_W8_created_data}/Uganda_UNPS_W8_food_consumption_value_combined.dta", replace
...
qui gen Instrument="Uganda LSMS-ISA/UNPS W8"
...
replace conv_lcu_ppp=	0.000775817	if Instrument==	"Uganda LSMS-ISA/UNPS W8"
...
compress
save "${final_data}/Uganda_UNPS_W8_food_consumption_value_by_source.dta", replace
