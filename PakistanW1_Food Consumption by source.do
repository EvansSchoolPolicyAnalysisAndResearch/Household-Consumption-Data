...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Pakistan Household Integrated Economic Survey (HIES) (2004-05)
...
*https://www.pbs.gov.pk/publication/household-integrated-economic-survey-hies-2004-05
...
*-----------
*Household ID variables				Pakistan_HIES_W1_hhids.dta
*Food Consumption by source			Pakistan_HIES_W1_food_consumption_value_by_source.dta
...
global Pakistan_HIES_W1_raw_data 			"$directory\Pakistan HIES\Pakistan HIES 2004-2005\data_in_stata"
global Pakistan_HIES_W1_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Pakistan_HIES_W1_exchange_rate 59.51			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=PK
global Pakistan_HIES_W1_gdp_ppp_dollar 13.04 		// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=PK
global Pakistan_HIES_W1_cons_ppp_dolar 14.64 		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=PK
global Pakistan_HIES_W1_inflation 1.811   		// inflation rate 2013-2017. Data was collected during October 2018-2019. We have adjusted values to 2017. https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=PK  
...
global Pakistan_HIES_W1_pop_tot 174372098
global Pakistan_HIES_W1_pop_rur 115116972
global Pakistan_HIES_W1_pop_urb 59255126

 
************************
*HOUSEHOLD IDS 
************************
use "${Pakistan_HIES_W1_raw_data}\sec_b0.dta", clear   
ren sbq01 gender
ren sbq04 age
codebook sbq03, tab(100)
gen fhh = gender==2 & sbq03==1
...
gen ccf_loc = (1 + $Pakistan_HIES_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $PKR"
*gen ccf_usd = (1 + $Pakistan_HIES_W1_inflation)/$Pakistan_HIES_W1_exchange_rate 
*lab var ccf_usd "currency conversion factor - 2017 $USD"
*gen ccf_1ppp = (1 + $Pakistan_HIES_W1_inflation)/ $Pakistan_HIES_W1_cons_ppp_dolar
...
gen eaten_out = inrange(itc, 2101, 2605)
gen at_home = inrange(itc, 1101, 1903)
...
replace crop_category1=	"Dairy"	if  item_code==	1107
replace crop_category1=	"Dairy"	if  item_code==	1108
replace crop_category1=	"Dairy"	if  item_code==	1109
...
replace crop_category1=	"Poultry Meat"	if  item_code==	1205
replace crop_category1=	"Fish and Seafood"	if  item_code==	1206
replace crop_category1=	"Fish and Seafood"	if  item_code==	1207
...
replace crop_category1=	"Fruits"	if  item_code==	1309
replace crop_category1=	"Fruits"	if  item_code==	1310
replace crop_category1=	"Fruits"	if  item_code==	1401
replace crop_category1=	"Nuts and Seeds"	if  item_code==	1402
...
replace crop_category1=	"Spices"	if  item_code==	1608
...
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	1804
replace crop_category1=	"Other Food"	if  item_code==	1901
replace crop_category1=	"Other Food"	if  item_code==	1902
replace crop_category1=	"Other Food"	if  item_code==	1903
...
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	2504
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	2505
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	2506
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	2601
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	2602
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	2603
replace crop_category1=	"Spices"	if  item_code==	2604
replace crop_category1=	"Spices"	if  item_code==	2605
...
replace crop_category1=	"Tobacco"	if  item_code==	4105
replace crop_category1=	"Tobacco"	if  item_code==	4106
replace crop_category1=	"Tobacco"	if  item_code==	4107
replace crop_category1=	"Tobacco"	if  item_code==	4108
replace crop_category1=	"Tobacco"	if  item_code==	4109
...
save "${Pakistan_HIES_W1_created_data}/Pakistan_HIES_W1_all_consumption_value_winsorized.dta",replace


use "${Pakistan_HIES_W1_created_data}/Pakistan_HIES_W1_all_consumption_value_winsorized.dta",clear
...
qui gen Instrument="Pakistan  HIES W1"
...
replace conv_lcu_ppp=	0.003961415	if Instrument==	"Pakistan  HIES W1"
...
compress
save "${final_data}/Pakistan_HIES_W1_food_consumption_value_by_source.dta", replace
