...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Uganda National Panel Survey (UNPS) LSMS-ISA Wave 4 (2013-14)
...
*The data were collected over the period September 2013 - August 2014.
...
*-----------
*Household ID variables				Uganda_UNPS_W4_hhids.dta
*Food Consumption by source			Uganda_UNPS_W4_food_consumption_value_by_source.dta
...
//set directories: 
global Uganda_UNPS_W4_raw_data 			"$directory/uganda-wave4-2013-14/raw_data/HH"
global Uganda_UNPS_W4_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Uganda_UNPS_W4_exchange_rate 2599.788			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=UG // average of 2013/2014
global Uganda_UNPS_W4_gdp_ppp_dollar 1270.6080   	// https://data.worldbank.org/indicator/PA.NUS.PPP // average of 2019/2020
global Uganda_UNPS_W4_cons_ppp_dollar 1221.0876		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP // average of 2019/2020
global Uganda_UNPS_W4_inflation 0.174298  	        	// https://data.worldbank.org/indicator/FP.CPI.TOTL.ZG?locations=UG inflation rate 2019-2020. Data was collected during 2019-2020. We want to adjust the monetary values to 2017


*Re-scaling survey weights to match population estimates
*https://databank.worldbank.org/source/world-development-indicators#
global Uganda_UNPS_W4_pop_tot 36336539
global Uganda_UNPS_W4_pop_rur 28522730
global Uganda_UNPS_W4_pop_urb 7813809
...
*HOUSEHOLD IDS
************************
use "${Uganda_UNPS_W4_raw_data}/GSEC2.dta", clear
ren h2q8 age
ren h2q3 gender
...
gen ccf_loc = (1 + $Uganda_UNPS_W4_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $Uganda_UNPS_W4_inflation)/$Uganda_UNPS_W4_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Uganda_UNPS_W4_inflation)/ $Uganda_UNPS_W4_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Uganda_UNPS_W4_inflation)/ $Uganda_UNPS_W4_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"

save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_hhids.dta", replace
...
*CONSUMPTION
******************************************************************************** 
use "${Uganda_UNPS_W4_raw_data}/GSEC15B.dta", clear
ren HHID hhid
...
merge m:1 hhid using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_hhids.dta", nogen keep (1 3)

save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_consumption_purchase.dta", replace
 
  
 
* ea
use "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_consumption_purchase.dta", clear
drop if price_unit==.
gen observation = 1
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_ea.dta", replace
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_parish.dta", replace
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_county.dta", replace
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_district.dta", replace
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_region.dta", replace
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_country.dta", replace
...
merge m:1 ea item_code food_purch_unit_new using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_ea.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 parish item_code food_purch_unit_new using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_parish.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 scounty_code item_code food_purch_unit_new using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_scounty.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 county item_code food_purch_unit_new using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_county.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 district item_code food_purch_unit_new using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 region item_code food_purch_unit_new using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 item_code food_purch_unit_new using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_item_prices_country.dta", nogen keep(1 3)
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_consumption_purchase_consu.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_consumption_purchase_prod.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_consumption_purchase_gift.dta", nogen
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_food_home_consumption_value.dta", replace
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_food_away_consumption_value.dta", replace


use "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_food_home_consumption_value.dta", clear
append using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_food_away_consumption_value.dta"
merge m:1 hhid using "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_hhids.dta", nogen keep(1 3)
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_food_consumption_value.dta", replace
...
save "${Uganda_UNPS_W4_created_data}/Uganda_UNPS_W4_food_consumption_value_combined.dta", replace
...
qui gen Instrument="Uganda LSMS-ISA/UNPS W4"
...
replace conv_lcu_ppp=	0.000991261	if Instrument==	"Uganda LSMS-ISA/UNPS W4"
...
save "${final_data}/Uganda_UNPS_W4_food_consumption_value_by_source.dta", replace
