...
merge m:1 lga district ea item_code food_purch_unit using "${Gambia_IHS_W3_created_data}/Gambia_IHS_W3_item_prices_ea.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 lga district item_code food_purch_unit using "${Gambia_IHS_W3_created_data}/Gambia_IHS_W3_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 lga item_code food_purch_unit using "${Gambia_IHS_W3_created_data}/Gambia_IHS_W3_item_prices_lga.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Gambia_IHS_W3_created_data}/Gambia_IHS_W3_item_prices_country.dta", nogen keep(1 3)
