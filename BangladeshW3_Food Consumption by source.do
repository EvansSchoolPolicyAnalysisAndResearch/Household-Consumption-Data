...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Bangladesh Integrated Household Survey (BIHS) 2018-2019
...
*The data were collected over the period November 2018 - April 2019.
...
*-----------
*Household ID variables				Bangladesh_IHS_W3_hhids.dta
*Food Consumption by source			Bangladesh_IHS_W3_food_consumption_value_by_source.dta
...
//set directories
global Bangladesh_IHS_W3_raw_data 			"$directory/Bangladesh IHS\Bangladesh IHS 2018-2019\BIHSRound3"
global Bangladesh_IHS_W3_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Bangladesh_IHS_W3_exchange_rate 80.44	// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=BD
global Bangladesh_IHS_W3_gdp_ppp_dollar 29.74  	// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=BDP
global Bangladesh_IHS_W3_cons_ppp_dolar 29.51 	// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=BD
global Bangladesh_IHS_W3_inflation 0.11   		// inflation rate 2013-2017. Data was collected during October 2018-2019. We have adjusted values to 2017. https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=BD  //https://www.worlddata.info/asia/bangladesh/inflation-rates.php
...
global Bangladesh_IHS_W3_pop_tot 165516222
global Bangladesh_IHS_W3_pop_rur 103604879
global Bangladesh_IHS_W3_pop_urb 61911343

 
************************
*HOUSEHOLD IDS 
************************
use "${Bangladesh_IHS_W3_raw_data}\Male\010_bihs_r3_male_mod_b1.dta", clear
merge m:1 a01 using "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Non-LSMS Datasets\Bangladesh IHS\Bangladesh IHS 2018-2019/158_BIHS sampling weights_r3.dta", nogen keep (1 3)
...
merge 1:m a01 using "${Bangladesh_IHS_W3_raw_data}/Female/092_bihs_r3_female_mod_a.dta", nogen keep (1 3)
ren div_name division
ren a01 hhid 
ren a16_1_dd interview_day
ren a16_1_mm interview_month
ren a16_1_yy interview_year
...
gen ccf_loc = (1 + $Bangladesh_IHS_W3_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $TZS"
*gen ccf_usd = (1 + $Bangladesh_IHS_W3_inflation)/$Bangladesh_IHS_W3_exchange_rate 
*lab var ccf_usd "currency conversion factor - 2017 $USD"
*gen ccf_1ppp = (1 + $Bangladesh_IHS_W3_inflation)/ $Bangladesh_IHS_W3_cons_ppp_dolar
*lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Bangladesh_IHS_W3_inflation)/ $Bangladesh_IHS_W3_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"

keep hhid division district upazila union mouza village weight fhh hh_members adulteq age_hh nadultworking nadultworking_female nadultworking_male nchildren nelders interview_day interview_month interview_year

save "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_hhids.dta", replace


********************************************************************************
*CONSUMPTION
******************************************************************************** 
use "${Bangladesh_IHS_W3_raw_data}\Female\096_bihs_r3_female_mod_o1.dta", clear
ren a01 hhid
merge m:1 hhid using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_hhids.dta", nogen keep (1 3)
...
replace crop_category1=	"Spices"	if  item_code==	2524
replace crop_category1=	"Spices"	if  item_code==	3232
...
label define unit 1"Kg" 2"Grams" 3"Liter" 4"Number", replace
label values food_purch_unit unit
label values food_prod_unit unit
label values food_gift_unit unit

gen food_gift_qty=o1_11 if o1_12==2
...
replace food_consu_qty=food_consu_qty/1000 if food_consu_unit==2  //changing grams in kg
...
recode price_unit (0=.)
gen country=1 
save "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_consumption_purchase.dta", replace
...
while `len'!=0 {
	...
	di "`g'"
	use "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_consumption_purchase.dta", clear
	...
	qui save "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_item_prices_`g'.dta", replace
...
merge m:1 division district upazila union mouza item_code food_purch_unit using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_item_prices_mouza.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 division district upazila union item_code food_purch_unit using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_item_prices_union.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 division district upazila item_code food_purch_unit using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_item_prices_upazila.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 division district item_code food_purch_unit using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 division item_code food_purch_unit using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_item_prices_division.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_item_prices_country.dta", nogen keep(1 3)
...
keep hhid item_code crop_category1 food_`f'_value food_consu_qty food_purch_qty food_prod_qty food_gift_qty
save "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_consumption_purchase_consu.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_consumption_purchase_prod.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_consumption_purchase_gift.dta", nogen

collapse (sum) food_consu_value food_purch_value food_prod_value food_gift_value (first) food_consu_qty food_purch_qty food_prod_qty food_gift_qty, by(hhid crop_category1)
...
save "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_food_home_consumption_value.dta", replace



*merge survey weight and household head variables
use "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_food_home_consumption_value.dta",clear
merge m:1 hhid using "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_hhids.dta", nogen keep(1 3)
...
save "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_food_consumption_value.dta", replace
...
save "${Bangladesh_IHS_W3_created_data}/Bangladesh_IHS_W3_food_consumption_value_combined.dta", replace
...
qui gen Instrument="Bangladesh IHS W3"
...
replace conv_lcu_ppp=	0.0321025	if Instrument==	"Bangladesh IHS W3"
...
compress
save "${final_data}/Bangladesh_IHS_W3_food_consumption_value_by_source.dta", replace
