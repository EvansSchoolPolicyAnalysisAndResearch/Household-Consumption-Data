...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Mali Enquête Harmonisée sur le Conditions de Vie des Ménages (EHCVM) (2018-19)
...
*Data source
*-----------
*The Mali Enquête Harmonisée sur le Conditions de Vie des Ménages Panel Survey was collected by the National Institute of Statistics and Demography (INSD)
...
*-----------
*This do.file constructs household consumption by source (purchased, own production and gifts) indicators at the crop and household level using the Mali EHCVM dataset.
...
*-----------
*Household ID variables				Mali_EHCVM_W1_hhids.dta
*Food Consumption by source			Mali_EHCVM_W1_food_consumption_value_by_source.dta
...
//set directories
global Mali_EHCVM_W1_raw_data 		"$directory\Mali\MLI_2018_EHCVM_v02_M_Stata"
global Mali_EHCVM_W1_created_data  "//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Mali_EHCVM_W1_exchange_rate 585.91  		// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=ML
global Mali_EHCVM_W1_gdp_ppp_dollar 212.81			// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=ML
global Mali_EHCVM_W1_cons_ppp_dollar 194.13			// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=ML
global Mali_EHCVM_W1_inflation 0.008				// inflation rate 2011-2017. Data was collected during 2010-2011. We want to adjust value to 2017 https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=ML
...
global Mali_EHCVM_W1_pop_tot 20567424
global Mali_EHCVM_W1_pop_rur 11695460
global Mali_EHCVM_W1_pop_urb 8871964
...
merge 1:m grappe menage using "${Mali_EHCVM_W1_raw_data}/s00_me_mli2018.dta", nogen keep (1 3)
ren s00q01 region 
...
gen ccf_loc = (1 + $Mali_EHCVM_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $Mali_EHCVM_W1_inflation)/$Mali_EHCVM_W1_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Mali_EHCVM_W1_inflation)/ $Mali_EHCVM_W1_cons_ppp_dollar
...
******************************************************************************** 
*Visit 1
use "${Mali_EHCVM_W1_raw_data}/s07b_me_mli2018.dta", clear
merge m:1 grappe menage using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_hhids.dta", nogen keep (1 3)
label list s07bq01l
...
gen country=1 
save "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_consumption_purchase.dta", replace
...
while `len'!=0 {
	...
	di "`g'"
	use "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_consumption_purchase.dta", clear
	...
	qui save "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_item_prices_`g'.dta", replace
...
*Removing duplicates
bysort grappe menage item_code crop_category1: gen dup=cond(_N==1,0,_n)
tab dup 
list item_code crop_category1 grappe menage if dup>=1
drop if dup>=1
...
merge m:1 region department grappe item_code food_purch_unit using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_item_prices_grappe.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region department item_code food_purch_unit using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_item_prices_department.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_item_prices_country.dta", nogen keep(1 3)
...
save "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1 grappe menage item_code crop_category1  using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_consumption_purchase_consu.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_consumption_purchase_prod.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_consumption_purchase_gift.dta", nogen
...
save "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_food_home_consumption_value.dta", replace

*Food away from home
use "${Mali_EHCVM_W1_raw_data}/s07a2_me_mli2018.dta", clear
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_food_away_consumption_value.dta", replace


use "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_food_home_consumption_value.dta", clear
append using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_food_away_consumption_value.dta"
merge m:1 grappe menage using "${Mali_EHCVM_W1_created_data}/Mali_EHCVM_W1_hhids.dta", nogen keep(1 3)
...
qui gen Instrument="Mali EHCVM W1"
...
replace GID_1="MLI.4_1"  if adm1==8
...
replace conv_lcu_ppp=	0.004857003	if Instrument==	"Mali EHCVM W1"
...
compress
save "${final_data}/Mali_EHCVM_W1_food_consumption_value_by_source.dta", replace
