...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Burkina Faso Enquête Harmonisée sur le Conditions de Vie des Ménages (EHCVM) Panel Survey (2021-22)
...
*Data source
*-----------
*The Burkina Faso Enquête Harmonisée sur le Conditions de Vie des Ménages Panel Survey was collected by the National Institute of Statistics and Demography (INSD)   
*The data were collected over the period October 2021 - December 2021, April - July 2022.
...
*-----------
*This do.file constructs household consumption by source (purchased, own production and gifts) indicators at the crop and household level using the Burkina Faso EHCVM data set.
...
*-----------
*Household ID variables				Burkina_EHCVM_W2_hhids.dta
*Food Consumption by source			Burkina_EHCVM_W2_food_consumption_value_by_source.dta
...
global directory			"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Non-LSMS Datasets/Enquête Harmonisée sur le Conditions de Vie des Ménages 2021-2022"

//set directories
global Burkina_EHCVM_W2_raw_data 		"$directory/Burkina Faso/Raw DTA Files"
*global Burkina_EHCVM_W2_created_data  "$directory/Burkina Faso/Final DTA Files/created_data"
*global inal_data  "$directory/Burkina Faso/DTA Final Files/final_data"


global Burkina_EHCVM_W2_created_data  "//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Burkina_EHCVM_W2_exchange_rate 585.91  		// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=BF
global Burkina_EHCVM_W2_gdp_ppp_dollar 205.69			// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=BF
global Burkina_EHCVM_W2_cons_ppp_dollar 188.94			// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=BF
global Burkina_EHCVM_W2_inflation 0.013			// inflation rate 2011-2017. Data was collected during 2010-2011. We want to adjust value to 2017 https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=BF
...
global Burkina_EHCVM_W2_pop_tot 20951639
global Burkina_EHCVM_W2_pop_rur 14670338
global Burkina_EHCVM_W2_pop_urb 6281301
...
* HOUSEHOLD IDS *
********************************************************************************
use "${Burkina_EHCVM_W2_raw_data}/ehcvm_panel_ponderations_bfa2021.dta", clear
...
gen ccf_loc = (1 + $Burkina_EHCVM_W2_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $Burkina_EHCVM_W2_inflation)/$Burkina_EHCVM_W2_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Burkina_EHCVM_W2_inflation)/ $Burkina_EHCVM_W2_cons_ppp_dollar
...
*CONSUMPTION
******************************************************************************** 
use "${Burkina_EHCVM_W2_raw_data}/s07b_me_bfa2021.dta", clear
merge m:1 grappe menage using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_hhids.dta", nogen keep (1 3)
label list s07Bq01
...
replace crop_category1=	"Maize"	if  item_code==	13
replace crop_category1=	"Millet and Sorghum"	if  item_code==	14
replace crop_category1=	"Millet and Sorghum"	if  item_code==	15
replace crop_category1=	"Wheat"	if  item_code==	16
replace crop_category1=	"Wheat"	if  item_code==	17
replace crop_category1=	"Other Cereals"	if  item_code==	18
replace crop_category1=	"Other Cereals"	if  item_code==	19
replace crop_category1=	"Wheat"	if  item_code==	20
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	21
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	22
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	23
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	24
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	25
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	26
replace crop_category1=	"Beef Meat"	if  item_code==	27
replace crop_category1=	"Other Meat"	if  item_code==	28
replace crop_category1=	"Lamb and Goat Meat"	if  item_code==	29
replace crop_category1=	"Lamb and Goat Meat"	if  item_code==	30
replace crop_category1=	"Other Meat"	if  item_code==	31
replace crop_category1=	"Pork Meat"	if  item_code==	32
replace crop_category1=	"Poultry Meat"	if  item_code==	33
replace crop_category1=	"Poultry Meat"	if  item_code==	34
replace crop_category1=	"Other Meat"	if  item_code==	35
replace crop_category1=	"Other Meat"	if  item_code==	36
replace crop_category1=	"Other Meat"	if  item_code==	37
replace crop_category1=	"Other Meat"	if  item_code==	38
replace crop_category1=	"Other Meat"	if  item_code==	39
...
replace crop_category1=	"Fish and Seafood"	if  item_code==	44
replace crop_category1=	"Fish and Seafood"	if  item_code==	45
replace crop_category1=	"Fish and Seafood"	if  item_code==	46
replace crop_category1=	"Fish and Seafood"	if  item_code==	47
replace crop_category1=	"Fish and Seafood"	if  item_code==	48
replace crop_category1=	"Fish and Seafood"	if  item_code==	49
replace crop_category1=	"Fish and Seafood"	if  item_code==	50
replace crop_category1=	"Fish and Seafood"	if  item_code==	51
replace crop_category1=	"Dairy"	if  item_code==	52
replace crop_category1=	"Dairy"	if  item_code==	53
replace crop_category1=	"Dairy"	if  item_code==	54
replace crop_category1=	"Dairy"	if  item_code==	55
replace crop_category1=	"Dairy"	if  item_code==	56
replace crop_category1=	"Dairy"	if  item_code==	57
replace crop_category1=	"Dairy"	if  item_code==	58
replace crop_category1=	"Dairy"	if  item_code==	59
replace crop_category1=	"Eggs"	if  item_code==	60
replace crop_category1=	"Oils, Fats"	if  item_code==	61
replace crop_category1=	"Oils, Fats"	if  item_code==	62
replace crop_category1=	"Oils, Fats"	if  item_code==	63
replace crop_category1=	"Oils, Fats"	if  item_code==	64
replace crop_category1=	"Oils, Fats"	if  item_code==	65
replace crop_category1=	"Oils, Fats"	if  item_code==	66
replace crop_category1=	"Oils, Fats"	if  item_code==	67
replace crop_category1=	"Oils, Fats"	if  item_code==	68
replace crop_category1=	"Oils, Fats"	if  item_code==	69
replace crop_category1=	"Oils, Fats"	if  item_code==	70
replace crop_category1=	"Fruits"	if  item_code==	71
replace crop_category1=	"Fruits"	if  item_code==	72
replace crop_category1=	"Fruits"	if  item_code==	73
replace crop_category1=	"Fruits"	if  item_code==	74
replace crop_category1=	"Fruits"	if  item_code==	75
replace crop_category1=	"Fruits"	if  item_code==	76
replace crop_category1=	"Fruits"	if  item_code==	77
replace crop_category1=	"Fruits"	if  item_code==	78
replace crop_category1=	"Fruits"	if  item_code==	79
replace crop_category1=	"Fruits"	if  item_code==	80
replace crop_category1=	"Fruits"	if  item_code==	81
replace crop_category1=	"Fruits"	if  item_code==	82
replace crop_category1=	"Fruits"	if  item_code==	83
replace crop_category1=	"Fruits"	if  item_code==	84
replace crop_category1=	"Fruits"	if  item_code==	85
replace crop_category1=	"Fruits"	if  item_code==	86
replace crop_category1=	"Fruits"	if  item_code==	87
...
replace crop_category1=	"Pulses"	if  item_code==	112
replace crop_category1=	"Groundnuts"	if  item_code==	113
replace crop_category1=	"Groundnuts"	if  item_code==	114
replace crop_category1=	"Groundnuts"	if  item_code==	115
replace crop_category1=	"Groundnuts"	if  item_code==	116
replace crop_category1=	"Groundnuts"	if  item_code==	117
replace crop_category1=	"Groundnuts"	if  item_code==	118
replace crop_category1=	"Other Food"	if  item_code==	119
replace crop_category1=	"Nuts and Seeds"	if  item_code==	120
replace crop_category1=	"Nuts and Seeds"	if  item_code==	121
replace crop_category1=	"Nuts and Seeds"	if  item_code==	122
replace crop_category1=	"Cassava"	if  item_code==	123
replace crop_category1=	"Yams"	if  item_code==	124
replace crop_category1=	"Yams"	if  item_code==	125
replace crop_category1=	"Bananas and Plantains"	if  item_code==	126
replace crop_category1=	"Potato"	if  item_code==	127
replace crop_category1=	"Other Roots and Tubers"	if  item_code==	128
replace crop_category1=	"Yams"	if  item_code==	129
replace crop_category1=	"Other Roots and Tubers"	if  item_code==	130
replace crop_category1=	"Cassava"	if  item_code==	131
replace crop_category1=	"Cassava"	if  item_code==	132
replace crop_category1=	"Cassava"	if  item_code==	133
replace crop_category1=	"Fruits"	if  item_code==	134
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	135
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	136
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	137
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	138
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	139
...
replace crop_category1=	"Spices"	if  item_code==	145
replace crop_category1=	"Spices"	if  item_code==	146
replace crop_category1=	"Spices"	if  item_code==	147
replace crop_category1=	"Spices"	if  item_code==	148
replace crop_category1=	"Spices"	if  item_code==	149
replace crop_category1=	"Spices"	if  item_code==	150
replace crop_category1=	"Spices"	if  item_code==	151
replace crop_category1=	"Spices"	if  item_code==	152
replace crop_category1=	"Spices"	if  item_code==	153
replace crop_category1=	"Nuts and Seeds"	if  item_code==	154
replace crop_category1=	"Other Food"	if  item_code==	155
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	156
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	157
...
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	165
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	166
replace crop_category1=	"Rice"	if  item_code==	167
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	168
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	169
replace crop_category1=	"Other Cereals"	if  item_code==	170
replace crop_category1=	"Other Meat"	if  item_code==	171
replace crop_category1=	"Poultry Meat"	if  item_code==	172
replace crop_category1=	"Fish and Seafood"	if  item_code==	173
replace crop_category1=	"Fish and Seafood"	if  item_code==	174
replace crop_category1=	"Dairy"	if  item_code==	175
replace crop_category1=	"Oils, Fats"	if  item_code==	176
replace crop_category1=	"Fruits"	if  item_code==	177
replace crop_category1=	"Other Food"	if  item_code==	178
replace crop_category1=	"Cassava"	if  item_code==	179
replace crop_category1=	"Fish and Seafood"	if  item_code==	180
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	181
...
gen country=1 
save "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_consumption_purchase.dta", replace
 
 
*Valuation using price_per_unit
global pgeo_vars country region province grappe
local len : word count $pgeo_vars
while `len'!=0 {
	local g : word  `len' of $pgeo_vars
	di "`g'"
	use "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_consumption_purchase.dta", clear
	...
	qui save "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_item_prices_`g'.dta", replace
...
merge m:1 region province grappe item_code food_purch_unit using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_item_prices_grappe.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region province item_code food_purch_unit using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_item_prices_province.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_item_prices_country.dta", nogen keep(1 3)
...
save "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1 grappe menage item_code crop_category1  using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_consumption_purchase_consu.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_consumption_purchase_prod.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_consumption_purchase_gift.dta", nogen
...
save "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_food_home_consumption_value.dta", replace

*Food away from home
use "${Burkina_EHCVM_W2_raw_data}/s07a_2_me_bfa2021.dta", clear
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_food_away_consumption_value.dta", replace

use "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_food_home_consumption_value.dta", clear
append using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_food_away_consumption_value.dta"
merge m:1 grappe menage using "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_hhids.dta", nogen keep(1 3)
...
save "${Burkina_EHCVM_W2_created_data}/Burkina_EHCVM_W2_food_consumption_value_combined.dta", replace
...
qui gen Instrument="Burkina EHCVM W2"
...
replace conv_lcu_ppp=	0.004910429	if Instrument==	"Burkina EHCVM W2"
...
compress
save "${final_data}/Burkina_EHCVM_W2_food_consumption_value_by_source.dta", replace
