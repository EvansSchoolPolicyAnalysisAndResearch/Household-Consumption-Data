...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Uganda National Panel Survey (UNPS) LSMS-ISA Wave 5 (2015-16)
...
*The data were collected over the period March 2015 - March 2016.
...
*-----------
*Household ID variables				Uganda_UNPS_W5_hhids.dta
*Food Consumption by source			Uganda_UNPS_W5_food_consumption_value_by_source.dta
...
global directory			    "//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/335 - Ag Team Data Support/Waves/Uganda NPS"
...
global Uganda_UNPS_W5_raw_data 			"$directory/uganda-wave5-2015-16/raw_data"
global Uganda_UNPS_W5_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Uganda_UNPS_W5_exchange_rate 3420.098			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=UG // average of 2019/2020
global Uganda_UNPS_W5_gdp_ppp_dollar 1270.6080   	// https://data.worldbank.org/indicator/PA.NUS.PPP // average of 2019/2020
global Uganda_UNPS_W5_cons_ppp_dollar 1221.0876		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP // average of 2019/2020
global Uganda_UNPS_W5_inflation 0.052097  	        	// https://data.worldbank.org/indicator/FP.CPI.TOTL.ZG?locations=UG inflation rate 2019-2020. Data was collected during 2019-2020. We want to adjust the monetary values to 2017


*DYA.11.1.2020 Re-scaling survey weights to match population estimates
*https://databank.worldbank.org/source/world-development-indicators#
global Uganda_UNPS_W5_pop_tot 38748299
global Uganda_UNPS_W5_pop_rur 29981884
global Uganda_UNPS_W5_pop_urb 8766415
...
*HOUSEHOLD IDS
************************
use "${Uganda_UNPS_W5_raw_data}/gsec2.dta", clear
ren h2q8 age
ren h2q3 gender
...
rename hwgt_W5  pweight // this is the panel weight.
...
gen ccf_loc = (1 + $Uganda_UNPS_W5_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $Uganda_UNPS_W5_inflation)/$Uganda_UNPS_W5_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Uganda_UNPS_W5_inflation)/ $Uganda_UNPS_W5_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Uganda_UNPS_W5_inflation)/ $Uganda_UNPS_W5_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"

save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_hhids.dta", replace
...
*CONSUMPTION
******************************************************************************** 
use "${Uganda_UNPS_W5_raw_data}/gsec15b.dta", clear
ren HHID hhid
...
replace crop_category1=	"Sweet Potato"	if  item_code==	180
replace crop_category1=	"Cassava"	if  item_code==	181
replace crop_category1=	"Cassava"	if  item_code==	182
replace crop_category1=	"Wheat"	if  item_code==	190
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	191
...
replace `unit'_unit_new="Cowboy/BlueBand Tin (0.125Kg)" if `unit'_unit==148
replace `unit'_unit_new="Sackets (25ml)" if `unit'_unit==800
replace `unit'_unit_new="Sackets (50ml)" if `unit'_unit==801
replace `unit'_unit_new="Sackets (100ml)" if `unit'_unit==802
...
replace `unit'_unit_new="Other" if `unit'_unit==136 | `unit'_unit==99
...
merge m:1 hhid using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_hhids.dta", nogen keep (1 3)

save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_consumption_purchase.dta", replace
 
  
 
* ea
use "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_consumption_purchase.dta", clear
drop if price_unit==.
gen observation = 1
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_ea.dta", replace
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_parish.dta", replace
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_scounty.dta", replace

* county 
use "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_consumption_purchase.dta", clear
drop if price_unit==.
gen observation = 1
bys scounty_code item_code food_purch_unit_new: egen obs_county = count(observation)
collapse (median) price_unit [aw=weight], by (scounty_code item_code food_purch_unit_new obs_county)
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_county.dta", replace
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_district.dta", replace
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_region.dta", replace
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_country.dta", replace
...
merge m:1 ea item_code food_purch_unit_new using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_ea.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 parish_code item_code food_purch_unit_new using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_parish.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 scounty_code item_code food_purch_unit_new using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_scounty.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 scounty_code item_code food_purch_unit_new using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_county.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 district item_code food_purch_unit_new using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 region item_code food_purch_unit_new using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_`f'_unit_new 
merge m:1 item_code food_purch_unit_new using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_item_prices_country.dta", nogen keep(1 3)
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_consumption_purchase_consu.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_consumption_purchase_prod.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_consumption_purchase_gift.dta", nogen
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_food_home_consumption_value.dta", replace
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_food_away_consumption_value.dta", replace


use "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_food_home_consumption_value.dta", clear
append using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_food_away_consumption_value.dta"
merge m:1 hhid using "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_hhids.dta", nogen keep(1 3)
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_food_consumption_value.dta", replace
...
save "${Uganda_UNPS_W5_created_data}/Uganda_UNPS_W5_food_consumption_value_combined.dta", replace

ren district adm1
lab var adm1 "Adminstrative subdivision 1 - state/region/province"
ren scounty_code adm2
...
qui gen Instrument="Uganda LSMS-ISA/UNPS W5"
...
replace conv_lcu_ppp=	0.000910773	if Instrument==	"Uganda LSMS-ISA/UNPS W5"
...
compress
save "${final_data}/Uganda_UNPS_W5_food_consumption_value_by_source.dta", replace
