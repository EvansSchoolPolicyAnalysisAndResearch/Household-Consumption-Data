...
collapse (sum) hh_members adulteq nadultworking nadultworking_female nadultworking_male nchildren nelders (max) fhh age_hh, by (household_id2)
...
ren hh_saq13_a interview_day
ren hh_saq13_b interview_month
ren hh_saq13_c interview_year
...
keep region zone woreda town subcity kebele ea household rural household_id2 weight fhh hh_members adulteq age_hh nadultworking nadultworking_female nadultworking_male nchildren nelders interview_day interview_month interview_year 
