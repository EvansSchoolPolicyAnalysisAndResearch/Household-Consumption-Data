...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Pakistan Household Integrated Economic Survey (HIES) (2018-19)
...
*-----------
*Household ID variables				Pakistan_HIES_W8_hhids.dta
*Food Consumption by source			Pakistan_HIES_W8_food_consumption_value_by_source.dta
...
//set directories
global Pakistan_HIES_W8_raw_data 			"$directory\Pakistan HIES\Pakistan HIES 2018-2019\data_in_stata"
global Pakistan_HIES_W8_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Pakistan_HIES_W8_exchange_rate 150.04			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=PK
global Pakistan_HIES_W8_gdp_ppp_dollar 36.48 		// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=PK
global Pakistan_HIES_W8_cons_ppp_dolar 37.04 		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=PK
global Pakistan_HIES_W8_inflation -0.139   		// inflation rate 2013-2017. Data was collected during October 2018-2019. We have adjusted values to 2017. https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=PK  
...
global Pakistan_HIES_W8_pop_tot 223293280
global Pakistan_HIES_W8_pop_rur 140882429
global Pakistan_HIES_W8_pop_urb 82410851

 
************************
*HOUSEHOLD IDS 
************************
use "${Pakistan_HIES_W8_raw_data}\plist.dta", clear
ren s1aq04 gender
...
gen ccf_loc = (1 + $Pakistan_HIES_W8_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $PKR"
*gen ccf_usd = (1 + $Pakistan_HIES_W8_inflation)/$Pakistan_HIES_W8_exchange_rate 
*lab var ccf_usd "currency conversion factor - 2017 $USD"
*gen ccf_1ppp = (1 + $Pakistan_HIES_W8_inflation)/ $Pakistan_HIES_W8_cons_ppp_dolar
*lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Pakistan_HIES_W8_inflation)/ $Pakistan_HIES_W8_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"
save "${Pakistan_HIES_W8_created_data}/Pakistan_HIES_W8_hhids.dta", replace


********************************************************************************
*CONSUMPTION 
******************************************************************************** 
use "${Pakistan_HIES_W8_raw_data}\sec_6a.dta", clear
merge m:1 hhcode using "${Pakistan_HIES_W8_created_data}/Pakistan_HIES_W8_hhids.dta", nogen keep (1 3)

label list itc
gen eaten_out = inrange(itc, 111101, 111127)
...
replace crop_category1=	"Rice"	if  item_code==	11103
replace crop_category1=	"Maize"	if  item_code==	11104
replace crop_category1=	"Maize"	if  item_code==	11105
replace crop_category1=	"Rice"	if  item_code==	11106
replace crop_category1=	"Other Cereals"	if  item_code==	11107
replace crop_category1=	"Pulses"	if  item_code==	11109
replace crop_category1=	"Pulses"	if  item_code==	11110
replace crop_category1=	"Pulses"	if  item_code==	11111
replace crop_category1=	"Pulses"	if  item_code==	11112
replace crop_category1=	"Pulses"	if  item_code==	11113
replace crop_category1=	"Pulses"	if  item_code==	11114
replace crop_category1=	"Pulses"	if  item_code==	11115
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	11116
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	11117
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	11118
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	11119
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	11120
replace crop_category1=	"Beef Meat"	if  item_code==	11201
replace crop_category1=	"Lamb and Goat Meat"	if  item_code==	11202
replace crop_category1=	"Poultry Meat"	if  item_code==	11203
replace crop_category1=	"Poultry Meat"	if  item_code==	11204
...
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	11404
replace crop_category1=	"Dairy"	if  item_code==	11405
replace crop_category1=	"Dairy"	if  item_code==	11406
replace crop_category1=	"Dairy"	if  item_code==	11407
replace crop_category1=	"Dairy"	if  item_code==	11408
replace crop_category1=	"Eggs"	if  item_code==	11409
replace crop_category1=	"Dairy"	if  item_code==	11410
...
replace crop_category1=	"Fruits"	if  item_code==	11601
replace crop_category1=	"Fruits"	if  item_code==	11602
replace crop_category1=	"Fruits"	if  item_code==	11603
...
replace crop_category1=	"Nuts and Seeds"	if  item_code==	11612
...
replace crop_category1=	"Fruits"	if  item_code==	11710
...
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	12205
...
replace crop_category1=	"Other Meat"	if  item_code==	111101
replace crop_category1=	"Pulses"	if  item_code==	111102
replace crop_category1=	"Vegetables"	if  item_code==	111103
replace crop_category1=	"Other Meat"	if  item_code==	111104
replace crop_category1=	"Rice"	if  item_code==	111105
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	111106
replace crop_category1=	"Dairy"	if  item_code==	111107
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	111108
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	111109
...
replace crop_category1=	"Wheat"	if  item_code==	111113
replace crop_category1=	"Other Food"	if  item_code==	111114
replace crop_category1=	"Other Meat"	if  item_code==	111115
replace crop_category1=	"Pulses"	if  item_code==	111116
replace crop_category1=	"Vegetables"	if  item_code==	111117
replace crop_category1=	"Other Meat"	if  item_code==	111118
replace crop_category1=	"Rice"	if  item_code==	111119
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	111120
replace crop_category1=	"Dairy"	if  item_code==	111121
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	111122
replace crop_category1=	"Non-Dairy Beverages"	if  item_code==	111123
replace crop_category1=	"Other Food"	if  item_code==	111124
replace crop_category1=	"Other Food"	if  item_code==	111125
replace crop_category1=	"Other Food"	if  item_code==	111126
replace crop_category1=	"Wheat"	if  item_code==	111127
drop if item_code== 11108 //Dropping cost of grinding, husking and cleaning cereals. 
...
save "${Pakistan_HIES_W8_created_data}/Pakistan_HIES_W8_all_consumption_value_winsorized.dta",replace


use "${Pakistan_HIES_W8_created_data}/Pakistan_HIES_W8_all_consumption_value_winsorized.dta",clear
...
qui gen Instrument="Pakistan HIES W8"
...
replace conv_lcu_ppp=	0.000775817	if Instrument==	"Pakistan HIES W8"
...
compress
save "${final_data}/Pakistan_HIES_W8_food_consumption_value_by_source.dta", replace
