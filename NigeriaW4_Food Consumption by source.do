...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Nigeria General Household Survey (GHS) LSMS-ISA Wave 4 (2018-19)
...
*The data were collected over the period July - September 2018, January - February 2019.
...
*-----------
*Household ID variables				Nigeria_GHS_W4_hhids.dta
*Food Consumption by source			Nigeria_GHS_W4_food_consumption_value_by_source.dta
...
********************************************************************************
global Nigeria_GHS_W4_exchange_rate 306.921		// https://www.bloomberg.com/quote/USDETB:CUR
global Nigeria_GHS_W4_gdp_ppp_dollar 115.9778		// https://data.worldbank.org/indicator/PA.NUS.PPP
global Nigeria_GHS_W4_cons_ppp_dollar 112.0983		// https://data.worldbank.org/indicator/PA.NUS.PRVT.P
global Nigeria_GHS_W4_inflation -0.199167		// inflation rate 2013-2017. Data was collected during 2012-2013. We want to ajhust value to 2017
global Nigeria_GHS_W4_inflation 0


*Re-scaling survey weights to match population estimates
*https://databank.worldbank.org/source/world-development-indicators#
global Nigeria_GHS_W4_pop_tot 2.03E+08
global Nigeria_GHS_W4_pop_rur 99300013
global Nigeria_GHS_W4_pop_urb 1.04E+08
...
ren s7bq9b food_purch_unit
ren s7bq5a food_purch_qty
ren s7bq10  food_purch_value    
ren s7bq6a food_prod_qty
*ren s7bq6b food_prod_unit    //Same unit with consumption in W4
ren s7bq7a food_gift_qty
*ren s7bq7b food_gift_unit    //Same unit with consumption in W4
ren s7bq2b_os food_consu_unit_others
ren s7bq9b_os food_purch_unit_others


foreach unit in  food_consu food_purch {
...
replace food_prod_qty=food_prod_qty/1000 if food_consu_unit==2
replace food_gift_qty=food_gift_qty/1000 if food_consu_unit==2
...
replace food_prod_qty=food_prod_qty/100 if food_consu_unit==4
replace food_gift_qty=food_gift_qty/100 if food_consu_unit==4

recode food_consu_unit food_purch_unit (2 =1 ) (4=3)  // grams in kg and mili in liter
...
recode price_unit (0=.)
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PP.dta", replace
 
 
use "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PP.dta", clear
drop if price_unit==.
gen observation = 1
...
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_ea_PP.dta", replace
...
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_lga_PP.dta", replace
...
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_state_PP.dta", replace
...
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_zone_PP.dta", replace
...
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_country_PP.dta", replace
...
merge m:1 zone state lga ea item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_ea_PP.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 zone state lga item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_lga_PP.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 zone state item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_state_PP.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 zone item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_zone_PP.dta", nogen keep(1 3)
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_country_PP.dta", nogen keep(1 3)
...
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PP_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PP_consu.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PP_prod.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PP_gift.dta", nogen
...
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_home_consumption_value_PP.dta", replace
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_away_consumption_value_PP.dta", replace

use "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_home_consumption_value_PP.dta", clear
append using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_away_consumption_value_PP.dta"
merge m:1 hhid using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_hhids.dta", nogen keep(1 3)
...
gen visit="PP"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_consumption_value_PP.dta", replace
...
ren s10bq9b food_purch_unit
ren s10bq9a  food_purch_qty
ren s10bq10 food_purch_value
ren s10bq6a food_prod_qty
*ren s10bq6b food_prod_unit    //Same unit with consumption in W4
ren s10bq7a food_gift_qty
*ren s10bq7b food_gift_unit    //Same unit with consumption in W4
ren s10bq2b_os food_consu_unit_others
ren s10bq9b_os food_purch_unit_others
*ren s10bq6b_os food_prod_unit_others    //Same unit with consumption in W4
*ren s10bq7b_os food_gift_unit_others    //Same unit with consumption in W4
...
gen price_unit= food_purch_value/food_purch_qty
recode price_unit (0=.)
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PH.dta", replace
 
 
use "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PH.dta", clear
drop if price_unit==.
gen observation = 1
bys zone state lga ea item_code food_purch_unit_new: egen obs_ea = count(observation)
collapse (median) price_unit [aw=weight], by (zone state lga ea item_code food_purch_unit_new obs_ea)
...
lab var price_unit_median_ea "Median price per kg for this crop in the enumeration area"
lab var obs_ea "Number of observations for this crop in the enumeration area"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_ea_PH.dta", replace
...
lab var price_unit_median_lga "Median price per kg for this crop in the lga"
lab var obs_lga "Number of observations for this crop in the lga"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_lga_PH.dta", replace
...
lab var price_unit_median_state "Median price per kg for this crop in the state"
lab var obs_state "Number of observations for this crop in the state"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_state_PH.dta", replace
...
lab var price_unit_median_zone "Median price per kg for this crop in the zone"
lab var obs_zone "Number of observations for this crop in the zone"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_zone_PH.dta", replace
...
lab var price_unit_median_country "Median price per kg for this crop in the country"
lab var obs_country "Number of observations for this crop in the country"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_country_PH.dta", replace
...
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 zone state lga ea item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_ea_PH.dta", nogen keep(1 3)
replace food_`f'_value=food_`f'_qty*price_unit_median_ea if food_consu_unit_new==food_purch_unit_new & food_`f'_value==. & obs_ea>10 & obs_ea!=.

*- using LGA medians with at least 10 observations
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 zone state lga item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_lga_PH.dta", nogen keep(1 3)
replace food_`f'_value=food_`f'_qty*price_unit_median_lga if food_consu_unit_new==food_purch_unit_new & food_`f'_value==. & obs_lga>10 & obs_lga!=.

*- using state medians with at least 10 observations
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 zone state item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_state_PH.dta", nogen keep(1 3)
replace food_`f'_value=food_`f'_qty*price_unit_median_state if food_consu_unit_new==food_purch_unit_new & food_`f'_value==. & obs_state>10 & obs_state!=.

*- using zone medians with at least 10 observations
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 zone item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_zone_PH.dta", nogen keep(1 3)
replace food_`f'_value=food_`f'_qty*price_unit_median_zone if food_consu_unit_new==food_purch_unit_new & food_`f'_value==. & obs_zone>10 & obs_zone!=.

*- using country medians
drop food_purch_unit_new 
gen food_purch_unit_new=food_consu_unit_new 
merge m:1 item_code food_purch_unit_new using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_item_prices_country_PH.dta", nogen keep(1 3)
replace food_`f'_value=food_`f'_qty*price_unit_median_country if food_consu_unit_new==food_purch_unit_new & food_`f'_value==. & obs_country>10 & obs_country!=.

keep hhid item_code crop_category1 food_`f'_value
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PH_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PH_consu.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PH_prod.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_consumption_purchase_PH_gift.dta", nogen
...
label var food_prod_value "Value of food produced by household over the past 7 days"
label var food_gift_value "Value of food received as a gift over the past 7 days"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_home_consumption_value_PH.dta", replace
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_away_consumption_value_PH.dta", replace

use "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_home_consumption_value_PH.dta", clear
append using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_away_consumption_value_PH.dta"
...
gen visit="PH"
save "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_consumption_value_PH.dta", replace


 *Average PP and PH
use "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_consumption_value_PP.dta", clear
append using "${Nigeria_GHS_W4_created_data}/Nigeria_GHS_W4_food_consumption_value_PH.dta"
...
qui gen Instrument="Nigeria LSMS-ISA/GHS W4"
...
replace conv_lcu_ppp=	0.007958188	if Instrument==	"Nigeria LSMS-ISA/GHS W4"
...
compress
save "${final_data}/Nigeria_GHS_W4_food_consumption_value_by_source.dta", replace
