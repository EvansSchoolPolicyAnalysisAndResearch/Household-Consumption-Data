...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Ethiopia Socioeconomic Survey (ESS) LSMS-ISA Wave 4 (2018-19)
...
*The data were collected over the period September 2018 - August 2019.
...
*-----------
*Household ID variables				Ethiopia_ESS_W4_hhids.dta
*Food Consumption by source			Ethiopia_ESS_W4_food_consumption_value_by_source.dta
...
********************************************************************************
global Ethiopia_ESS_W4_exchange_rate 23.87 // 2017 - updated SRK 7.3.24 // https://data.worldbank.org/indicator/PA.NUS.FCRF?end=2023&locations=ET&skipRedirection=true&start=2007&year=2017 
global Ethiopia_ESS_W4_gdp_ppp_dollar 8.34 	// 2017 - updated SRK 7.3.24 // https://data.worldbank.org/indicator/PA.NUS.PPP?end=2023&locations=ET&skipRedirection=true&start=2010&view=chart&year=2017
global Ethiopia_ESS_W4_cons_ppp_dollar 8.21	 // 2017 - updated SRK 7.3.24 // https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?end=2017&locations=ET&start=2011
global Ethiopia_ESS_W4_inflation -0.242236 // (CPI_2017-CPI_SURVEY_YEAR/CPI_SURVEY_YEAR) -> (CPI_2017-CPI_2019/CPI_2019) - updated SRK 7.3.24 // https://data.worldbank.org/indicator/FP.CPI.TOTL?end=2023&locations=ET&start=2009


*Re-scaling survey weights to match population estimates
*https://databank.worldbank.org/source/world-development-indicators#
global Ethiopia_ESS_W4_pop_tot 114120594 // 2019
global Ethiopia_ESS_W4_pop_rur 89898498 // 2019
global Ethiopia_ESS_W4_pop_urb 24222096 // 2019
...
gen ccf_usd = (1 + $Ethiopia_ESS_W4_inflation)/$Ethiopia_ESS_W4_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Ethiopia_ESS_W4_inflation)/ $Ethiopia_ESS_W4_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Ethiopia_ESS_W4_inflation)/ $Ethiopia_ESS_W4_gdp_ppp_dollar
...
replace crop_category1=	"Bananas and Plantains"			if  item_code==	209
...
replace crop_category1=	"Fruits"			if  item_code==	501
...
replace crop_category1=	"Other Roots and Tubers"			if  item_code==	602
replace crop_category1=	"Other Roots and Tubers"			if  item_code==	603
...
replace crop_category1=	"Other Roots and Tubers"			if  item_code==	607
...
replace crop_category1=	"Other Food"			if  item_code==	713
...
replace crop_category1=	"Other Food"			if  item_code==	902
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_consumption_purchase.dta", replace
 

use "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_consumption_purchase.dta", clear
drop if price_unit==.
gen observation = 1
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_ea.dta", replace
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_kebele.dta", replace
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_subcity.dta", replace
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_woreda.dta", replace
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_zone.dta", replace
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_region.dta", replace
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_country.dta", replace
...
merge m:1 region zone woreda subcity kebele ea item_code food_purch_unit using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_ea.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region zone woreda subcity kebele item_code food_purch_unit using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_kebele.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region zone woreda subcity item_code food_purch_unit using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_subcity.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region zone woreda item_code food_purch_unit using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_woreda.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region zone item_code food_purch_unit using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_zone.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_item_prices_country.dta", nogen keep(1 3)
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_consumption_purchase_consu.dta", nogen
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_food_home_consumption_value.dta", replace

sum food_consu_value food_purch_value food_prod_value food_gift_value


use "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_food_home_consumption_value.dta", clear
merge m:1 hhid using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_hhids.dta", nogen keep(1 3)
...
save "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_food_consumption_value.dta", replace  
...
merge m:1 hhid using "${Ethiopia_ESS_W4_created_data}/Ethiopia_ESS_W4_hhids.dta", nogen keepusing(ccf_1ppp ccf_2ppp)
gen conv_lcu_ppp=.
lab var conv_lcu_ppp "Conversion Factor"		
replace conv_lcu_ppp=	ccf_2ppp	if Instrument==	"Ethiopia LSMS-ISA/ESS W4"
