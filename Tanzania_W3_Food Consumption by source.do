...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Tanzania National Panel Survey (NPS) LSMS-ISA Wave 3 (2012-13)
...
*-----------
*Household ID variables				Tanzania_NPS_W3_hhids.dta
*Food Consumption by source			Tanzania_NPS_W3_food_consumption_value_by_source.dta
...
global Tanzania_NPS_W3_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data" 
...
********************************************************************************
global Tanzania_NPS_W3_exchange_rate 1597.556			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=TZ
global Tanzania_NPS_W3_gdp_ppp_dollar 885.0829  		// https://data.worldbank.org/indicator/PA.NUS.PPP
global Tanzania_NPS_W3_cons_ppp_dollar 754.6215 		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP
global Tanzania_NPS_W3_inflation 0.241301   		// inflation rate 2013-2017. Data was collected during October 2012-2013. We have adjusted values to 2016. https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=TZ
...
global Tanzania_NPS_W3_pop_tot 49253643
global Tanzania_NPS_W3_pop_rur 34381013
global Tanzania_NPS_W3_pop_urb 14872630
...
collapse (max) fhh age_hh (sum) hh_members (sum) adulteq nadultworking nadultworking_female nadultworking_male nchildren nelders, by(y3_hhid)

merge 1:1 y3_hhid using "${Tanzania_NPS_W3_raw_data}/HH_SEC_A.dta", nogen keep (1 3)
ren hh_a01_1 region 
...
ren hh_a18_1 interview_day
ren hh_a18_2 interview_month
ren hh_a18_3 interview_year
...
keep y3_hhid region district ward ea rural weight strataid clusterid y2_hhid hh_split fhh hh_members adulteq age_hh nadultworking nadultworking_female nadultworking_male nchildren nelders interview_day interview_month interview_year
...
*gen ccf_usd = (1 + $Malawi_IHS_W1_inflation)/$Tanzania_NPS_W3_exchange_rate 
...
recode food_consu_unit food_purch_unit food_prod_unit food_gift_unit (2 =1 ) (4=3)  // grams in kg and milliliters in liter // AYW: I moved this line below the lines above. It seems the same should be done for the other countries.
...
recode price_unit (0=.)
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_consumption_purchase.dta", replace
 

use "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_consumption_purchase.dta", clear
drop if price_unit==.
gen observation = 1
...
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_ea.dta", replace
...
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_ward.dta", replace
...
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_district.dta", replace
...
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_region.dta", replace
...
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_country.dta", replace
...
merge m:1 region district ward ea item_code food_purch_unit using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_ea.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region district ward item_code food_purch_unit using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_ward.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region district item_code food_purch_unit using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_item_prices_country.dta", nogen keep(1 3)
...
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  y3_hhid item_code crop_category1  using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_consumption_purchase_consu.dta", nogen
merge 1:1  y3_hhid item_code crop_category1  using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_consumption_purchase_prod.dta", nogen
merge 1:1  y3_hhid item_code crop_category1  using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_consumption_purchase_gift.dta", nogen

collapse (sum) food_consu_value food_purch_value food_prod_value food_gift_value, by(y3_hhid crop_category1)
...
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_food_home_consumption_value.dta", replace


*Food away from home
use "${Tanzania_NPS_W3_raw_data}/hh_sec_f.dta", clear
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_food_away_consumption_value.dta", replace

use "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_food_home_consumption_value.dta", clear
append using "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_food_away_consumption_value.dta"
merge m:1 y3_hhid using "${Tanzania_NPS_W3_created_data}/Tanzania_NPS_W3_hhids.dta", nogen keep(1 3)
ren y3_hhid hhid
...
save "${Tanzania_NPS_W3_created_data }/Tanzania_NPS_W3_food_consumption_value.dta", replace
...
qui gen Instrument="Tanzania LSMS-ISA/NPS W3"
...
replace conv_lcu_ppp=	0.0017744	if Instrument==	"Tanzania LSMS-ISA/NPS W3"
...
compress
save "${final_data}/Tanzania_NPS_W3_food_consumption_value_by_source.dta", replace
