...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Pakistan Household Integrated Economic Survey (HIES) (2010-11)
...
*https://www.pbs.gov.pk/publication/household-integrated-economic-survey-hies-2010-11
...
*-----------
*Household ID variables				Pakistan_HIES_W4_hhids.dta
*Food Consumption by source			Pakistan_HIES_W4_food_consumption_value_by_source.dta
...
//set directories
global Pakistan_HIES_W4_raw_data 			"$directory\Pakistan HIES\Pakistan HIES 2010-2011\data_in_stata"
global Pakistan_HIES_W4_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Pakistan_HIES_W4_exchange_rate 86.34			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=PK
global Pakistan_HIES_W4_gdp_ppp_dollar 24.96 		// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=PK
global Pakistan_HIES_W4_cons_ppp_dolar 25.5 		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=PK
global Pakistan_HIES_W4_inflation 0.402   		// inflation rate 2013-2017. Data was collected during October 2018-2019. We have adjusted values to 2017. https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=PK  
...
global Pakistan_HIES_W4_pop_tot 198602738
global Pakistan_HIES_W4_pop_rur 128690602
global Pakistan_HIES_W4_pop_urb 69912136

 
************************
*HOUSEHOLD IDS 
************************
use "${Pakistan_HIES_W4_raw_data}\plist.dta", clear   
ren sbq03 gender
codebook sbq02, tab(100)
gen fhh = gender==2 & sbq02==1
lab var fhh "1= Female-headed Household"
gen hh_members = 1 if sbq10==1
...
gen ccf_loc = (1 + $Pakistan_HIES_W4_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $PKR"
*gen ccf_usd = (1 + $Pakistan_HIES_W4_inflation)/$Pakistan_HIES_W4_exchange_rate 
*lab var ccf_usd "currency conversion factor - 2017 $USD"
*gen ccf_1ppp = (1 + $Pakistan_HIES_W4_inflation)/ $Pakistan_HIES_W4_cons_ppp_dolar
*lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Pakistan_HIES_W4_inflation)/ $Pakistan_HIES_W4_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"

save "${Pakistan_HIES_W4_created_data}/Pakistan_HIES_W4_hhids.dta", replace


********************************************************************************
*CONSUMPTION 
******************************************************************************** 
use "${Pakistan_HIES_W4_raw_data}\sec_Labcde.dta", clear
merge m:1 hhcode using "${Pakistan_HIES_W4_created_data}/Pakistan_HIES_W4_hhids.dta", nogen keep (1 3)
...
save "${Pakistan_HIES_W4_created_data}/Pakistan_HIES_W4_all_consumption_value_winsorized.dta",replace

use "${Pakistan_HIES_W4_created_data}/Pakistan_HIES_W4_all_consumption_value_winsorized.dta",clear
...
qui gen Instrument="Pakistan HIES W4"
...
replace conv_lcu_ppp=	0.003961415	if Instrument==	"Pakistan HIES W4"
...
compress
save "${final_data}/Pakistan_HIES_W4_food_consumption_value_by_source.dta", replace
