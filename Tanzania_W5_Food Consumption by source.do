...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Tanzania National Panel Survey (NPS) LSMS-ISA Wave 5 (2019-20)
...
*The data were collected over the period January 2019 - January 2020.
...
*-----------
*Household ID variables				Tanzania_NPS_W5_hhids.dta
*Food Consumption by source			Tanzania_NPS_W5_food_consumption_value_by_source.dta
...
global Tanzania_NPS_W5_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Tanzania_NPS_W5_exchange_rate 2288.207			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=TZ
global Tanzania_NPS_W5_gdp_ppp_dollar 885.0829  		// https://data.worldbank.org/indicator/PA.NUS.PPP
global Tanzania_NPS_W5_cons_ppp_dollar 754.6215 		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP
global Tanzania_NPS_W5_inflation -0.066117   		// inflation rate 2013-2017. Data was collected during October 2014-2015. We have adjusted values to 2017. https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=TZ
...
global Tanzania_NPS_W5_pop_tot 59872579
global Tanzania_NPS_W5_pop_rur 39216539
global Tanzania_NPS_W5_pop_urb 20656040
...
collapse (max) fhh age_hh (sum) hh_members (sum) adulteq nadultworking nadultworking_female nadultworking_male nchildren nelders, by(y5_hhid)

merge 1:1 y5_hhid using "${Tanzania_NPS_W5_raw_data}/HH_SEC_A.dta", nogen keep (1 3)
ren hh_a01_1 region 
...
ren int_month_code2 interview_month
gen interview_year=2021
replace interview_year=2020 if int_month_year==1
replace interview_year=2022 if int_month_year==14

lab var interview_month "Survey interview month"
lab var interview_year "Survey interview year"

keep y5_hhid region district ward village ward_name village_name ea rural weight strataid clusterid fhh hh_members adulteq age_hh nadultworking nadultworking_female nadultworking_male nchildren nelders interview_month interview_year
...
*gen ccf_usd = (1 + $Malawi_IHS_W1_inflation)/$Tanzania_NPS_W5_exchange_rate 
...
recode food_consu_unit food_purch_unit food_prod_unit food_gift_unit (7=.) (2 =1 ) (4=3)  // grams in kg and milliliters in liter 
...
recode price_unit (0=.)
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_consumption_purchase.dta", replace
 

use "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_consumption_purchase.dta", clear
drop if price_unit==.
gen observation = 1
...
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_ea.dta", replace
...
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_ward.dta", replace
...
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_district.dta", replace
...
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_region.dta", replace
...
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_country.dta", replace
...
merge m:1 region district ward ea item_code food_purch_unit using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_ea.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region district ward item_code food_purch_unit using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_ward.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region district item_code food_purch_unit using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_item_prices_country.dta", nogen keep(1 3)
...
keep y5_hhid item_code crop_category1 food_`f'_value
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  y5_hhid item_code crop_category1  using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_consumption_purchase_consu.dta", nogen
merge 1:1  y5_hhid item_code crop_category1  using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_consumption_purchase_prod.dta", nogen
merge 1:1  y5_hhid item_code crop_category1  using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_consumption_purchase_gift.dta", nogen

collapse (sum) food_consu_value food_purch_value food_prod_value food_gift_value, by(y5_hhid crop_category1)
...
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_food_home_consumption_value.dta", replace


*Food away from home
use "${Tanzania_NPS_W5_raw_data}/hh_sec_f.dta", clear
egen food_purch_value=rowtotal(hh_f03 hh_f05 hh_f07 hh_f09 hh_f11 hh_f13 hh_f15)
gen  food_consu_value=food_purch_value

collapse (sum) food_consu_value food_purch_value, by(y5_hhid)
gen crop_category1="Meals away from home"
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_food_away_consumption_value.dta", replace

use "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_food_home_consumption_value.dta", clear
append using "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_food_away_consumption_value.dta"
...
save "${Tanzania_NPS_W5_created_data}/Tanzania_NPS_W5_food_consumption_value.dta", replace
...
replace GID_1="TZA.31_1"  if adm1==26
...
replace conv_lcu_ppp=	0.001237552	if Instrument==	"Tanzania LSMS-ISA/NPS W5"
...
compress
save "${final_data}/Tanzania_NPS_W5_food_consumption_value_by_source.dta", replace
