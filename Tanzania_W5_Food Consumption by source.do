...
collapse (sum) hh_members adulteq (max) fhh, by (sdd_hhid)

merge 1:1 sdd_hhid using "${Tanzania_NPS_W5_raw_data}/HH_SEC_A.dta", nogen keep (1 3)
ren hh_a01_1 region 
...
keep y5_hhid region district ward village ward_name village_name ea rural weight strataid clusterid fhh hh_members adulteq
