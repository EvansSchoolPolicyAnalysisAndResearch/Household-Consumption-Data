...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Benin Enquête Harmonisée sur le Conditions de Vie des Ménages (EHCVM) (2018-19)
...
*Data source
*-----------
*The Benin Enquête Harmonisée sur le Conditions de Vie des Ménages Panel Survey was collected by the National Institute of Statistics and Demography (INSD) 
...
*-----------
*Household ID variables				Benin_EHCVM_W1_hhids.dta
*Food Consumption by source			Benin_EHCVM_W1_food_consumption_value_by_source.dta
...
//set directories
global Benin_EHCVM_W1_raw_data 		"$directory\Benin\BEN_2018_EHCVM_v02_M_Stata"
global Benin_EHCVM_W1_created_data  "//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Benin_EHCVM_W1_exchange_rate 589.95  		// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=BJ
global Benin_EHCVM_W1_gdp_ppp_dollar 208.52			// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=BJ
global Benin_EHCVM_W1_cons_ppp_dollar 210.29			// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=BJ
global Benin_EHCVM_W1_inflation 0.0001				// inflation rate 2011-2017. Data was collected during 2010-2011. We want to adjust value to 2017 https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=BJ


*Re-scaling survey weights to match population estimates
*https://databank.worldbank.org/source/world-development-indicators#
global Benin_EHCVM_W1_pop_tot 12290444
global Benin_EHCVM_W1_pop_rur 6408115
global Benin_EHCVM_W1_pop_urb 5882329
...
* HOUSEHOLD IDS *
********************************************************************************
use "${Benin_EHCVM_W1_raw_data}/ehcvm_ponderations_ben2018.dta", clear
merge 1:m grappe using "${Benin_EHCVM_W1_raw_data}/s01_me_ben2018.dta", nogen keep (1 3)
ren hhweight weight
...
merge 1:m grappe menage using "${Benin_EHCVM_W1_raw_data}/s00_me_ben2018.dta", nogen keep (1 3)
ren s00q01 region 
...
gen ccf_loc = (1 + $Benin_EHCVM_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $Benin_EHCVM_W1_inflation)/$Benin_EHCVM_W1_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Benin_EHCVM_W1_inflation)/ $Benin_EHCVM_W1_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Benin_EHCVM_W1_inflation)/ $Benin_EHCVM_W1_gdp_ppp_dollar
...
gen country=1 
save "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_consumption_purchase.dta", replace
...
while `len'!=0 {
	...
	di "`g'"
	use "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_consumption_purchase.dta", clear
	...
	qui save "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_item_prices_`g'.dta", replace
...
merge m:1 region department grappe item_code food_purch_unit using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_item_prices_grappe.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region department item_code food_purch_unit using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_item_prices_department.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_item_prices_country.dta", nogen keep(1 3)
...
save "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1 grappe menage item_code crop_category1  using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_consumption_purchase_consu.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_consumption_purchase_prod.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_consumption_purchase_gift.dta", nogen
...
save "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_food_home_consumption_value.dta", replace

*Food away from home
use "${Benin_EHCVM_W1_raw_data}/s07a2_me_ben2018.dta", clear
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_food_away_consumption_value.dta", replace

use "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_food_home_consumption_value.dta", clear
append using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_food_away_consumption_value.dta"
merge m:1 grappe menage using "${Benin_EHCVM_W1_created_data}/Benin_EHCVM_W1_hhids.dta", nogen keep(1 3)
...
qui gen Country="Benin"
lab var Country "Country name"
qui gen Instrument="Benin EHCVM W1"
...
gen GID_1=""
replace GID_1="BEN.1_1"  if adm1==1
replace GID_1="BEN.2_1"  if adm1==2
replace GID_1="BEN.3_1"  if adm1==3
replace GID_1="BEN.4_1"  if adm1==4
replace GID_1="BEN.5_1"  if adm1==5
replace GID_1="BEN.6_1"  if adm1==7
replace GID_1="BEN.7_1"  if adm1==6
replace GID_1="BEN.8_1"  if adm1==8
replace GID_1="BEN.9_1"  if adm1==9
replace GID_1="BEN.10_1"  if adm1==10
replace GID_1="BEN.11_1"  if adm1==11
replace GID_1="BEN.12_1"  if adm1==12
...
replace conv_lcu_ppp=	0.0045271	if Instrument==	"Benin EHCVM W1"
...
compress
save "${final_data}/Benin_EHCVM_W1_food_consumption_value_by_source.dta", replace
