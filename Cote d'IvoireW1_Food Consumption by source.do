...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Cote d'Ivoire Enquête Harmonisée sur le Conditions de Vie des Ménages (EHCVM) Panel Survey (2018-19)
...
*Data source
*-----------
*The Cote d'Ivoire Enquête Harmonisée sur le Conditions de Vie des Ménages Panel Survey was collected by the National Institute of Statistics and Demography (INSD) 
*The data were collected over the period September 2018 - December 2018, April - July 2019.
...
*-----------
*This do.file constructs household consumption by source (purchased, own production and gifts) indicators at the crop and household level using the Cote d'Ivoire EHCVM data set.
...
*-----------
*Household ID variables				CI_EHCVM_W1_hhids.dta
*Food Consumption by source			CI_EHCVM_W1_food_consumption_value_by_source.dta
...
global directory			"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Non-LSMS Datasets/Enquête Harmonisée sur le Conditions de Vie des Ménages 2018-2019"

//set directories
global CI_EHCVM_W1_raw_data 		"$directory/Cote d'Ivoire/CIV_2018_EHCVM_v02_M_Stata"
global CI_EHCVM_W1_created_data  "//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global CI_EHCVM_W1_exchange_rate 585.91  		// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=CI
global CI_EHCVM_W1_gdp_ppp_dollar 250.88			// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=CI
global CI_EHCVM_W1_cons_ppp_dollar 235.17			// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=CI
global CI_EHCVM_W1_inflation 0.008				// inflation rate 2011-2017. Data was collected during 2010-2011. We want to adjust value to 2017 https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=CI
...
global CI_EHCVM_W1_pop_tot 26147551
global CI_EHCVM_W1_pop_rur 12749807
global CI_EHCVM_W1_pop_urb 13397744
...
* HOUSEHOLD IDS *
********************************************************************************
use "${CI_EHCVM_W1_raw_data}/ehcvm_ponderations_civ2018.dta", clear
merge 1:m grappe using "${CI_EHCVM_W1_raw_data}/s01_me_civ2018.dta", nogen keep (1 3)
ren hhweight weight
...
merge 1:m grappe menage using "${CI_EHCVM_W1_raw_data}/s00_me_civ2018.dta", nogen keep (1 3)
ren s00q01 region 
...
gen ccf_loc = (1 + $CI_EHCVM_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $CI_EHCVM_W1_inflation)/$CI_EHCVM_W1_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $CI_EHCVM_W1_inflation)/ $CI_EHCVM_W1_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $CI_EHCVM_W1_inflation)/ $CI_EHCVM_W1_gdp_ppp_dollar
...
save  "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_hhids.dta", replace
...
*CONSUMPTION
******************************************************************************** 
use "${CI_EHCVM_W1_raw_data}/s07b_me_civ2018.dta", clear
merge m:1 grappe menage using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_hhids.dta", nogen keep (1 3)
label list S07BQ01
...
replace crop_category1=	"Vegetables"	if  item_code==	84
...
gen country=1 
save "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_consumption_purchase.dta", replace
...
while `len'!=0 {
	...
	di "`g'"
	use "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_consumption_purchase.dta", clear
	...
	qui save "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_item_prices_`g'.dta", replace
...
merge m:1 region department grappe item_code food_purch_unit using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_item_prices_grappe.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region department item_code food_purch_unit using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_item_prices_department.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_item_prices_country.dta", nogen keep(1 3)
...
save "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1 grappe menage item_code crop_category1  using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_consumption_purchase_consu.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_consumption_purchase_prod.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_consumption_purchase_gift.dta", nogen
...
save "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_food_home_consumption_value.dta", replace

*Food away from home
use "${CI_EHCVM_W1_raw_data}/s07a2_me_civ2018.dta", clear
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_food_away_consumption_value.dta", replace


use "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_food_home_consumption_value.dta", clear
append using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_food_away_consumption_value.dta"
merge m:1 grappe menage using "${CI_EHCVM_W1_created_data}/CI_EHCVM_W1_hhids.dta", nogen keep(1 3)
...
qui gen Country="Cote d'Ivoire"
lab var Country "Country name"
qui gen Instrument="CI EHCVM W1"
lab var Instrument "Survey name"
qui gen Year="2018/19"
lab var Year "Survey year"

keep hhid crop_category1 food_consu_value food_purch_value food_prod_value food_gift_value hh_members adulteq age_hh nadultworking nadultworking_female nadultworking_male nchildren nelders interview_day interview_month interview_yea fhh adm1 adm2 adm3 weight rural w_food_consu_value w_food_purch_value w_food_prod_value w_food_gift_value Country Instrument Year

*generate GID_1 code to match codes in the CI shapefile
//Rearranged using this resource: https://assets.publishing.service.gov.uk/media/5a7f36a440f0b6230268e223/Ivory_Coast_Administrative_Structure.pdf
gen GID_1=""
replace GID_1="CIV.1_1"  if adm1==1
replace GID_1="CIV.2_1"  if adm1==9
replace GID_1="CIV.2_1"  if adm1==31
replace GID_1="CIV.2_1"  if adm1==25
replace GID_1="CIV.3_1"  if adm1==13
replace GID_1="CIV.3_1"  if adm1==5
replace GID_1="CIV.4_1"  if adm1==10
replace GID_1="CIV.4_1"  if adm1==24
replace GID_1="CIV.5_1"  if adm1==15
replace GID_1="CIV.5_1"  if adm1==17
replace GID_1="CIV.6_1"  if adm1==21
replace GID_1="CIV.6_1"  if adm1==11
replace GID_1="CIV.6_1"  if adm1==33
replace GID_1="CIV.6_1"  if adm1==29
replace GID_1="CIV.7_1"  if adm1==16
replace GID_1="CIV.7_1"  if adm1==26
replace GID_1="CIV.7_1"  if adm1==30
replace GID_1="CIV.8_1"  if adm1==18
replace GID_1="CIV.8_1"  if adm1==6
replace GID_1="CIV.8_1"  if adm1==27
replace GID_1="CIV.9_1"  if adm1==2
replace GID_1="CIV.9_1"  if adm1==12
replace GID_1="CIV.10_1"  if adm1==3
replace GID_1="CIV.10_1"  if adm1==32
replace GID_1="CIV.10_1"  if adm1==20
replace GID_1="CIV.11_1"  if adm1==4
replace GID_1="CIV.11_1"  if adm1==28
replace GID_1="CIV.12_1"  if adm1==19
replace GID_1="CIV.12_1"  if adm1==22
replace GID_1="CIV.12_1"  if adm1==14
replace GID_1="CIV.13_1"  if adm1==7
replace GID_1="CIV.14_1"  if adm1==8
replace GID_1="CIV.14_1"  if adm1==23
...
replace conv_lcu_ppp=	0.00403189	if Instrument==	"CI EHCVM W1"
...
compress
save "${final_data}/CI_EHCVM_W1_food_consumption_value_by_source.dta", replace
