...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Tanzania National Panel Survey (NPS) LSMS-ISA Wave 1 (2008-09)
...
*-----------
*Household ID variables				Tanzania_NPS_W1_hhids.dta
*Food Consumption by source			Tanzania_NPS_W1_food_consumption_value_by_source.dta
...
global Tanzania_NPS_W1_created_data  	"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Tanzania_NPS_W1_exchange_rate 1320.312		// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=TZ
global Tanzania_NPS_W1_gdp_ppp_dollar 885.0829		// https://data.worldbank.org/indicator/PA.NUS.PPP
global Tanzania_NPS_W1_cons_ppp_dollar 754.6215		// https://data.worldbank.org/indicator/PA.NUS.PRVT.P
global Tanzania_NPS_W1_inflation 0.858904			// inflation rate 2009-2016. Data was collected during Oct 2008- Sep 2009. We want to adjust value to 2017. 
...
global Tanzania_NPS_W1_pop_tot 43957933
global Tanzania_NPS_W1_pop_rur 31896316
global Tanzania_NPS_W1_pop_urb 12061617
...
collapse (max) fhh age_hh (sum) hh_members (sum) adulteq nadultworking nadultworking_female nadultworking_male nchildren nelders, by(hhid)

merge 1:1 hhid using "${Tanzania_NPS_W1_raw_data}\SEC_A_T.dta", nogen keep (1 3)
rename hh_weight_trimmed weight
ren rural oldrural
gen rural=oldrural=="Rural"
lab var rural "1=Household lives in a rural area"

ren sa2q18m interview_month
ren sa2q18y interview_year
lab var interview_month "Survey interview month"
lab var interview_year "Survey interview year"


keep hhid region district ward ea rural weight strataid clusterid hh_members adulteq age_hh nadultworking nadultworking_female nadultworking_male nchildren nelders interview_month interview_year fhh
...
replace level_representativness=4 if !inlist(region,7,53) & rural==1
...
*gen ccf_usd = (1 + $Malawi_IHS_W1_inflation)/$Tanzania_NPS_W1_exchange_rate 
...
ren skq1 food_consu_yesno
ren skq2_meas food_consu_unit
ren skq2_amount food_consu_qty
ren skq3_meas food_purch_unit
ren skq3_amount food_purch_qty
ren skq4 food_purch_value
ren skq5_meas food_prod_unit
ren skq5_amount food_prod_qty
ren skq6_meas food_gift_unit
ren skq6_amount food_gift_qty
...
recode price_unit (0=.)
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_consumption_purchase.dta", replace
 

use "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_consumption_purchase.dta", clear
drop if price_unit==.
gen observation = 1
...
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_ea.dta", replace
...
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_ward.dta", replace
...
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_district.dta", replace
...
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_region.dta", replace
...
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_country.dta", replace
...
merge m:1 region district ward ea item_code food_purch_unit using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_ea.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region district ward item_code food_purch_unit using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_ward.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region district item_code food_purch_unit using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_item_prices_country.dta", nogen keep(1 3)
...
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_consumption_purchase_consu.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_consumption_purchase_prod.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_consumption_purchase_gift.dta", nogen
...
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_food_home_consumption_value.dta", replace


*Food away from home
use "${Tanzania_NPS_W1_raw_data}/SEC_B_C_D_E1_F_G1_U.dta", clear
egen food_purch_value=rowtotal(sfq5 sfq7 sfq9 sfq11 sfq13 sfq15)
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_food_away_consumption_value.dta", replace

use "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_food_home_consumption_value.dta", clear
append using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_food_away_consumption_value.dta"
merge m:1 hhid using "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_hhids.dta", nogen keep(1 3)
...
save "${Tanzania_NPS_W1_created_data}/Tanzania_NPS_W1_food_consumption_value.dta", replace
...
qui gen Instrument="Tanzania LSMS-ISA/NPS W1"
lab var Instrument "Survey name"
qui gen Year="2008/09"
...
replace conv_lcu_ppp=	0.002762467	if Instrument==	"Tanzania LSMS-ISA/NPS W1"
...
compress
save "${final_data}/Tanzania_NPS_W1_food_consumption_value_by_source.dta", replace
