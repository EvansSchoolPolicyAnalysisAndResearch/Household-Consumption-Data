...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Bangladesh Integrated Household Survey (BIHS) 2011-2012
...
*The data were collected over the period October 2011 - June 2012.
...
*-----------
*Household ID variables				Bangladesh_IHS_W1_hhids.dta
*Food Consumption by source			Bangladesh_IHS_W1_food_consumption_value_by_source.dta
...
global Bangladesh_IHS_W1_raw_data 			"$directory/Bangladesh IHS\Bangladesh IHS 2011-2012"
global Bangladesh_IHS_W1_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Bangladesh_IHS_W1_exchange_rate 77.4		// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=BD
global Bangladesh_IHS_W1_gdp_ppp_dollar 23.79  	// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=BD
global Bangladesh_IHS_W1_cons_ppp_dolar 24.42 	// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=BD
global Bangladesh_IHS_W1_inflation 0.51   		// inflation rate 2013-2017. Data was collected during October 2018-2019. We have adjusted values to 2017. https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=BD  //https://www.worlddata.info/asia/bangladesh/inflation-rates.php


*Re-scaling survey weights to match population estimates
*https://databank.worldbank.org/source/world-development-indicators#
global Bangladesh_IHS_W1_pop_tot 152090649
global Bangladesh_IHS_W1_pop_rur 103432288
global Bangladesh_IHS_W1_pop_urb 48658361
...
*HOUSEHOLD IDS 
************************
use "${Bangladesh_IHS_W1_raw_data}\003_mod_b1_male.dta", clear
merge m:1 a01 using "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Non-LSMS Datasets\Bangladesh IHS\Bangladesh IHS 2011-2012/BIHS_FTF baseline sampling weights.dta", nogen keep (1 3)
ren hhweight weight
ren b1_02 age
ren b1_01 gender
...
gen ccf_loc = (1 + $Bangladesh_IHS_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $TZS"
*gen ccf_usd = (1 + $Bangladesh_IHS_W1_inflation)/$Bangladesh_IHS_W1_exchange_rate 
*lab var ccf_usd "currency conversion factor - 2017 $USD"
*gen ccf_1ppp = (1 + $Bangladesh_IHS_W1_inflation)/ $Bangladesh_IHS_W1_cons_ppp_dolar
...
*CONSUMPTION
******************************************************************************** 
use "${Bangladesh_IHS_W1_raw_data}\031_mod_o1_female.dta", clear
ren a01 hhid
merge m:1 hhid using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_hhids.dta", nogen keep (1 3)
...
replace crop_category1=	"Potato"	if  item_code==	62
...
replace crop_category1=	"Sugar, Sweets, Pastries"	if  item_code==	320
...
replace crop_category1=	"Vegetables"	if  item_code==	903
replace crop_category1=	"Vegetables"	if  item_code==	904
replace crop_category1=	"Other Meat"	if  item_code==	905
...
save "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_consumption_purchase.dta", replace


 *Valuation using price_per_unit
global pgeo_vars country division district upazila union
local len : word count $pgeo_vars
while `len'!=0 {
	local g : word  `len' of $pgeo_vars
	di "`g'"
	use "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_consumption_purchase.dta", clear
	...
	qui save "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_item_prices_`g'.dta", replace
...
merge m:1 division district upazila union item_code food_purch_unit using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_item_prices_union.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 division district upazila item_code food_purch_unit using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_item_prices_upazila.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 division district item_code food_purch_unit using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_item_prices_district.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 division item_code food_purch_unit using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_item_prices_division.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_item_prices_country.dta", nogen keep(1 3)
...
save "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1  hhid item_code crop_category1  using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_consumption_purchase_consu.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_consumption_purchase_prod.dta", nogen
merge 1:1  hhid item_code crop_category1  using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_consumption_purchase_gift.dta", nogen
...
save "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_food_home_consumption_value.dta", replace


*merge survey weight and household head variables
use "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_food_home_consumption_value.dta",clear
merge m:1 hhid using "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_hhids.dta", nogen keep(1 3)
...
save "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_food_consumption_value.dta", replace
...
save "${Bangladesh_IHS_W1_created_data}/Bangladesh_IHS_W1_food_consumption_value_combined.dta", replace
...
qui gen Instrument="Bangladesh IHS W1"
...
replace conv_lcu_ppp=	0.000775817	if Instrument==	"Bangladesh IHS W1"
