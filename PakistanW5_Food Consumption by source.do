...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Pakistan Household Integrated Economic Survey (HIES) (2011-12)
...
*https://www.pbs.gov.pk/publication/household-integrated-economic-survey-hies-2011-12
...
*-----------
*Household ID variables				Pakistan_HIES_W5_hhids.dta
*Food Consumption by source			Pakistan_HIES_W5_food_consumption_value_by_source.dta
...
//set directories
global Pakistan_HIES_W5_raw_data 			"$directory\Pakistan HIES\Pakistan HIES 2011-2012\data_in_stata"
global Pakistan_HIES_W5_created_data 		"//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Pakistan_HIES_W5_exchange_rate 93.4			// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=PK
global Pakistan_HIES_W5_gdp_ppp_dollar 26.64 		// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=PK
global Pakistan_HIES_W5_cons_ppp_dolar 26.52 		// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=PK
global Pakistan_HIES_W5_inflation 0.278   		// inflation rate 2013-2017. Data was collected during October 2018-2019. We have adjusted values to 2017. https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=PK  
...
global Pakistan_HIES_W5_pop_tot 202205861
global Pakistan_HIES_W5_pop_rur 130608810
global Pakistan_HIES_W5_pop_urb 71597051

 
************************
*HOUSEHOLD IDS 
************************
use "${Pakistan_HIES_W5_raw_data}\plist.dta", clear   
ren s1aq03 gender
...
gen ccf_loc = (1 + $Pakistan_HIES_W5_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $PKR"
*gen ccf_usd = (1 + $Pakistan_HIES_W5_inflation)/$Pakistan_HIES_W5_exchange_rate 
*lab var ccf_usd "currency conversion factor - 2017 $USD"
*gen ccf_1ppp = (1 + $Pakistan_HIES_W5_inflation)/ $Pakistan_HIES_W5_cons_ppp_dolar
*lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Pakistan_HIES_W5_inflation)/ $Pakistan_HIES_W5_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"

save "${Pakistan_HIES_W5_created_data}/Pakistan_HIES_W5_hhids.dta", replace


********************************************************************************
*CONSUMPTION 
******************************************************************************** 
use "${Pakistan_HIES_W5_raw_data}\sec_6abcde.dta", clear
merge m:1 hhcode using "${Pakistan_HIES_W5_created_data}/Pakistan_HIES_W5_hhids.dta", nogen keep (1 3)

label list itc
gen eaten_out = inrange(itc, 2101, 2601)
*replace eaten_out = inrange(itc, 4101, 4104)   //Inclusive of Tobacco
...
replace crop_category1=	"Other Food"	if  item_code==	2600
replace crop_category1=	"Spices"	if  item_code==	2601
...
drop if  item_code==	1580 //Dropping food items not captured in the instrument. 
...
save "${Pakistan_HIES_W5_created_data}/Pakistan_HIES_W5_all_consumption_value_winsorized.dta",replace


use "${Pakistan_HIES_W5_created_data}/Pakistan_HIES_W5_all_consumption_value_winsorized.dta",clear
...
qui gen Instrument="Pakistan HIES W5"
...
replace conv_lcu_ppp=	0.0421658	if Instrument==	"Pakistan HIES W5"
...
ren hhid old_hhid
gen hhid=string(old_hhid, "%18.0f")
drop old_hhid

compress
save "${final_data}/Pakistan_HIES_W5_food_consumption_value_by_source.dta", replace
