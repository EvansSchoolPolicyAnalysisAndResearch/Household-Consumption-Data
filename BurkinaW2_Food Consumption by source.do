...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Burkina Faso Enquête Harmonisée sur le Conditions de Vie des Ménages (EHCVM) Panel Survey (2018-19)
...
*-----------
*Household ID variables				Burkina_EHCVM_W1_hhids.dta
*Food Consumption by source			Burkina_EHCVM_W1_food_consumption_value_by_source.dta
...
//set directories
global Burkina_EHCVM_W1_raw_data 		"$directory/Burkina Faso/BFA_2018_EHCVM_v02_M_Stata"
global Burkina_EHCVM_W1_created_data  "//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Burkina_EHCVM_W1_exchange_rate 585.91  		// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=BF
global Burkina_EHCVM_W1_gdp_ppp_dollar 205.69			// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=BF
global Burkina_EHCVM_W1_cons_ppp_dollar 188.94			// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=BF
global Burkina_EHCVM_W1_inflation 0.013			// inflation rate 2011-2017. Data was collected during 2010-2011. We want to adjust value to 2017 https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=BF
...
global Burkina_EHCVM_W1_pop_tot 20951639
global Burkina_EHCVM_W1_pop_rur 14670338
global Burkina_EHCVM_W1_pop_urb 6281301
...
* HOUSEHOLD IDS *
********************************************************************************
use "${Burkina_EHCVM_W1_raw_data}/ehcvm_ponderations_bfa2018.dta", clear
merge 1:m grappe using "${Burkina_EHCVM_W1_raw_data}/s01_me_bfa2018.dta", nogen keep (1 3)
ren hhweight weight
...
merge 1:m grappe menage using "${Burkina_EHCVM_W1_raw_data}/s00_me_bfa2018.dta", nogen keep (1 3)
ren s00q01 region 
...
gen ccf_loc = (1 + $Burkina_EHCVM_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $Burkina_EHCVM_W1_inflation)/$Burkina_EHCVM_W1_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Burkina_EHCVM_W1_inflation)/ $Burkina_EHCVM_W1_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Burkina_EHCVM_W1_inflation)/ $Burkina_EHCVM_W1_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"

keep grappe menage region department fhh weight hh_members adulteq rural
save  "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_hhids.dta", replace

 
********************************************************************************
*CONSUMPTION
******************************************************************************** 
use "${Burkina_EHCVM_W1_raw_data}/s07b_me_bfa2018.dta", clear
merge m:1 grappe menage using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_hhids.dta", nogen keep (1 3)
...
replace crop_category1=	"Maize"	if  item_code==	11
...
replace crop_category1=	"Nuts and Seeds"	if  item_code==	128
replace crop_category1=	"Other Food"	if  item_code==	129
...
gen country=1 
save "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_consumption_purchase.dta", replace
...
while `len'!=0 {
	...
	di "`g'"
	use "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_consumption_purchase.dta", clear
	...
	qui save "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_item_prices_`g'.dta", replace
...
merge m:1 region department grappe item_code food_purch_unit using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_item_prices_grappe.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region department item_code food_purch_unit using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_item_prices_department.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_item_prices_country.dta", nogen keep(1 3)
...
save "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1 grappe menage item_code crop_category1  using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_consumption_purchase_consu.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_consumption_purchase_prod.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_consumption_purchase_gift.dta", nogen
...
save "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_food_home_consumption_value.dta", replace

*Food away from home
use "${Burkina_EHCVM_W1_raw_data}/s07a2_me_bfa2018.dta", clear
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_food_away_consumption_value.dta", replace

use "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_food_home_consumption_value.dta", clear
append using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_food_away_consumption_value.dta"
merge m:1 grappe menage using "${Burkina_EHCVM_W1_created_data}/Burkina_EHCVM_W1_hhids.dta", nogen keep(1 3)
...
qui gen Instrument="Burkina EHCVM W1"
...
gen GID_1=""
replace GID_1="BFA.1_1"  if adm1==1
replace GID_1="BFA.2_1"  if adm1==2
replace GID_1="BFA.7_1"  if adm1==3
replace GID_1="BFA.3_1"  if adm1==4
replace GID_1="BFA.4_1"  if adm1==5
replace GID_1="BFA.5_1"  if adm1==6
replace GID_1="BFA.6_1"  if adm1==7
replace GID_1="BFA.8_1"  if adm1==8
replace GID_1="BFA.9_1"  if adm1==9
replace GID_1="BFA.10_1"  if adm1==10
...
replace conv_lcu_ppp=	0.005140117	if Instrument==	"Burkina EHCVM W1"
...
compress
save "${final_data}/Burkina_EHCVM_W1_food_consumption_value_by_source.dta", replace
