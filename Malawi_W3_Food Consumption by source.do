...
collapse (sum) hh_members adulteq nadultworking nadultworking_female nadultworking_male nchildren nelders (max) fhh age_hh, by (y3_hhid)
...
ren interviewdate_v1 first_interview_date
...
keep y3_hhid case_id region district ea ta weight region rural fhh hh_members adulteq age_hh nadultworking nadultworking_female nadultworking_male nchildren nelders interview_day interview_month interview_year
