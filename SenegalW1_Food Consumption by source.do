...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				 ...
				 (purchased, own production and gifts) indicators using the Senegal Enquête Harmonisée sur le Conditions de Vie des Ménages (EHCVM) (2018-19)
...
*Data source
*-----------
*The Senegal Enquête Harmonisée sur le Conditions de Vie des Ménages Panel Survey was collected by the National Agency of Statistics and Demography ( ANSD )
*The data were collected over the period September - December 2018; April - July 2019.
...
*-----------
*This do.file constructs household consumption by source (purchased, own production and gifts) indicators at the crop and household level using the Senegal EHCVM dataset.
...
*-----------
*Household ID variables				Senegal_EHCVM_W1_hhids.dta
*Food Consumption by source			Senegal_EHCVM_W1_food_consumption_value_by_source.dta
...
//set directories
global Senegal_EHCVM_W1_raw_data 		"$directory/Senegal/SEN_2018_EHCVM_v02_M_Stata"
global Senegal_EHCVM_W1_created_data  "//netid.washington.edu/wfs/EvansEPAR/Project/EPAR/Working Files/439 - Household Food Consumption by Source/Food consumption by source/Consumption Data Curation/created_data"
...
********************************************************************************
global Senegal_EHCVM_W1_exchange_rate 555.45  		// https://data.worldbank.org/indicator/PA.NUS.FCRF?locations=SN
global Senegal_EHCVM_W1_gdp_ppp_dollar 239.65			// https://data.worldbank.org/indicator/PA.NUS.PPP?locations=SN
global Senegal_EHCVM_W1_cons_ppp_dollar 233.84			// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP?locations=SN
global Senegal_EHCVM_W1_inflation -0.022				// inflation rate 2011-2017. Data was collected during 2010-2011. We want to adjust value to 2017 https://data.worldbank.org/indicator/FP.CPI.TOTL?locations=SN


*DYA.11.1.2020 Re-scaling survey weights to match population estimates
*https://databank.worldbank.org/source/world-development-indicators#
global Senegal_EHCVM_W1_pop_tot 16000781
global Senegal_EHCVM_W1_pop_rur 8375929
global Senegal_EHCVM_W1_pop_urb 7624852
...
* HOUSEHOLD IDS *
********************************************************************************
use "${Senegal_EHCVM_W1_raw_data}/ehcvm_ponderations_sen2018.dta", clear
merge 1:m grappe using "${Senegal_EHCVM_W1_raw_data}/s01_me_sen2018.dta", nogen keep (1 3)
ren hhweight weight
...
merge 1:m grappe menage using "${Senegal_EHCVM_W1_raw_data}/s00_me_sen2018.dta", nogen keep (1 3)
ren s00q01 region 
...
gen ccf_loc = (1 + $Senegal_EHCVM_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2017 $SHL"
gen ccf_usd = (1 + $Senegal_EHCVM_W1_inflation)/$Senegal_EHCVM_W1_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = (1 + $Senegal_EHCVM_W1_inflation)/ $Senegal_EHCVM_W1_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = (1 + $Senegal_EHCVM_W1_inflation)/ $Senegal_EHCVM_W1_gdp_ppp_dollar
...
*CONSUMPTION
******************************************************************************** 
use "${Senegal_EHCVM_W1_raw_data}/s07b_me_sen2018.dta", clear
merge m:1 grappe menage using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_hhids.dta", nogen keep (1 3)
...
replace crop_category1=	"Pork Meat"	if  item_code==	25
...
replace crop_category1=	"Oils, Fats"	if  item_code==	139
replace crop_category1=	"Oils, Fats"	if  item_code==	140
...
gen country=1 
save "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_consumption_purchase.dta", replace
...
while `len'!=0 {
	...
	di "`g'"
	use "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_consumption_purchase.dta", clear
	...
	qui save "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_item_prices_`g'.dta", replace
...
merge m:1 region department grappe item_code food_purch_unit using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_item_prices_grappe.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region department item_code food_purch_unit using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_item_prices_department.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 region item_code food_purch_unit using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_item_prices_region.dta", nogen keep(1 3)
...
drop food_purch_unit 
gen food_purch_unit=food_`f'_unit 
merge m:1 item_code food_purch_unit using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_item_prices_country.dta", nogen keep(1 3)
...
save "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_consumption_purchase_`f'.dta", replace
restore
}

merge 1:1 grappe menage item_code crop_category1  using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_consumption_purchase_consu.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_consumption_purchase_prod.dta", nogen
merge 1:1 grappe menage item_code crop_category1  using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_consumption_purchase_gift.dta", nogen
...
save "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_food_home_consumption_value.dta", replace

*Food away from home
use "${Senegal_EHCVM_W1_raw_data}/s07a2_me_sen2018.dta", clear
...
label var food_consu_value "Value of food consumed over the past 7 days"
label var food_purch_value "Value of food purchased over the past 7 days"
save "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_food_away_consumption_value.dta", replace


use "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_food_home_consumption_value.dta", clear
append using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_food_away_consumption_value.dta"
merge m:1 grappe menage using "${Senegal_EHCVM_W1_created_data}/Senegal_EHCVM_W1_hhids.dta", nogen keep(1 3)
...
qui gen Country="Senegal"
lab var Country "Country name"
qui gen Instrument="Senegal EHCVM W1"
...
*generate GID_1 code to match codes in the Senegal shapefile
gen GID_1=""
replace GID_1="SEN.1_1"  if adm1==1
replace GID_1="SEN.2_1"  if adm1==3
replace GID_1="SEN.3_1"  if adm1==9
replace GID_1="SEN.4_1"  if adm1==12
replace GID_1="SEN.5_1"  if adm1==6
replace GID_1="SEN.6_1"  if adm1==13
replace GID_1="SEN.7_1"  if adm1==10
replace GID_1="SEN.8_1"  if adm1==8
replace GID_1="SEN.9_1"  if adm1==11
replace GID_1="SEN.10_1"  if adm1==4
replace GID_1="SEN.11_1"  if adm1==14
replace GID_1="SEN.12_1"  if adm1==5
replace GID_1="SEN.13_1"  if adm1==7
replace GID_1="SEN.14_1"  if adm1==2
...
replace conv_lcu_ppp=	0.004172273	if Instrument==	"Senegal EHCVM W1"
...
compress
save "${final_data}/Senegal_EHCVM_W1_food_consumption_value_by_source.dta", replace
